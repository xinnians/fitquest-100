...
import { signUpWithEmail, signInWithGoogle, signInWithApple, signInWithLINE } from "@/lib/auth-actions";
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center bg-background px-4">
      <div className="w-full max-w-sm">
        ...
        <p className="mt-2 text-center text-muted">建立帳號，開始你的 100 天冒險</p>
        ...
        <div className="mt-8 space-y-3">
          ...
          >
            {oauthLoading === "line" ? "連線中..." : <><LINEIcon /> 使用 LINE 註冊</>}
          </button>
          ...
          >
            {oauthLoading === "google" ? "連線中..." : <><GoogleIcon /> 使用 Google 註冊</>}
          </button>
          ...
          >
            {oauthLoading === "apple" ? "連線中..." : <><AppleIcon /> 使用 Apple 註冊</>}
          </button>
